...
if __name__ == "__main__":
    ...
    tokenizer_tmd = AutoTokenizer.from_pretrained(
        "/home/khoa/duyhc/RobustExperiment/model/weights/bert-base-uncased-imdb", use_fast=True
    )
    model = BertForSequenceClassification(config)
    state = AutoModelForSequenceClassification.from_pretrained(
        "/home/khoa/duyhc/RobustExperiment/model/weights/bert-base-uncased-imdb"
    )
    ...
    #load_path = "/home/khoa/duyhc/RobustExperiment/model/weights/bert-base-uncased-imdb"
