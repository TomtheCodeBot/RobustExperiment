...
if __name__ == "__main__":
    ...
    if args.model == "bert":
        ...
        if args.defense == "safer":
            ...
            BERT_SAFER = wrapping_model(safer_model,tokenizer,"safer",ensemble_num=args.ensemble_num,batch_size=args.ensemble_batch_size,safer_aug_set="model/weights/tmd_ckpts/imdb/perturbation_constraint_pca0.8_100.pkl")
    if args.model == "roberta":
        ...
        if args.defense == "safer":
            ...
            tokenizer_roberta.model_max_length=256
            print(safer_model.load_state_dict(torch.load(load_path,map_location = device), strict=False))
            ROBERTA_SAFER = wrapping_model(safer_model,tokenizer_roberta,"safer",ensemble_num=args.ensemble_num,batch_size=args.ensemble_batch_size,safer_aug_set="model/weights/tmd_ckpts/imdb/perturbation_constraint_pca0.8_100.pkl")
