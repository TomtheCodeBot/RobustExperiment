...
if __name__ == "__main__":
    ...
    print("LR Accuracy on the AGNEWS dataset: {:.2f}".format(acc*100))
    BERT = OpenAttackBert("/home/ubuntu/Robustness_Gym/model/weights/BERT/AGNEWS/ONNX",num_classes=4)
    ...
    GRU = loadGRUModel("/home/ubuntu/Robustness_Gym/model/weights/GRU/AGNEWS_WordTokenizer",map_location=torch.device("cpu"),classes=4)
    ...
    attacker = oa.attackers.TextBuggerAttacker()
    run_test(victim,attacker,y_pred_RNB,test_data["text"],test_labels,"AGNEWS","TextBugger","RNB")
    
    victim = OpenAttackMNB(RNB_50,vectorizer)
    run_test(victim,attacker,y_pred_RNB_50,test_data["text"],test_labels,"AGNEWS","TextBugger","RNB_50")
    
    victim = OpenAttackMNB(RNB_25,vectorizer)
    run_test(victim,attacker,y_pred_RNB_25,test_data["text"],test_labels,"AGNEWS","TextBugger","RNB_25")
    
    victim = OpenAttackMNB(RNB_15,vectorizer)
    run_test(victim,attacker,y_pred_RNB_15,test_data["text"],test_labels,"AGNEWS","TextBugger","RNB_15")
    
    victim = OpenAttackMNB(RNB_5,vectorizer)
    run_test(victim,attacker,y_pred_RNB_5,test_data["text"],test_labels,"AGNEWS","TextBugger","RNB_5")
    victim = OpenAttackMNB(MNB,vectorizer)
    run_test(victim,attacker,y_pred_MNB,test_data["text"],test_labels,"AGNEWS","TextBugger","MNB")
    
    victim = OpenAttackMNB(LR,vectorizer)
    run_test(victim,attacker,y_pred_LR,test_data["text"],test_labels,"AGNEWS","TextBugger","LR")
    
    victim = LSTM
    run_test(victim,attacker,y_pred_LSTM,test_data["text"],test_labels,"AGNEWS","TextBugger","LSTM")
    
    victim = OpenAttackMNB(RNB,vectorizer)
    attacker = oa.attackers.PWWSAttacker()
    run_test(victim,attacker,y_pred_RNB,test_data["text"],test_labels,"AGNEWS","PWWS","RNB")
    
    victim = OpenAttackMNB(RNB_50,vectorizer)
    run_test(victim,attacker,y_pred_RNB_50,test_data["text"],test_labels,"AGNEWS","PWWS","RNB_50")
    
    victim = OpenAttackMNB(RNB_25,vectorizer)
    run_test(victim,attacker,y_pred_RNB_25,test_data["text"],test_labels,"AGNEWS","PWWS","RNB_25")
    
    victim = OpenAttackMNB(RNB_15,vectorizer)
    run_test(victim,attacker,y_pred_RNB_15,test_data["text"],test_labels,"AGNEWS","PWWS","RNB_15")
    
    victim = OpenAttackMNB(RNB_5,vectorizer)
    run_test(victim,attacker,y_pred_RNB_5,test_data["text"],test_labels,"AGNEWS","PWWS","RNB_5")
    victim = OpenAttackMNB(MNB,vectorizer)
    run_test(victim,attacker,y_pred_MNB,test_data["text"],test_labels,"AGNEWS","PWWS","MNB")
    
    victim = OpenAttackMNB(LR,vectorizer)
    run_test(victim,attacker,y_pred_LR,test_data["text"],test_labels,"AGNEWS","PWWS","LR")
    
    victim = LSTM
    run_test(victim,attacker,y_pred_LSTM,test_data["text"],test_labels,"AGNEWS","PWWS","LSTM")
    
    victim = OpenAttackMNB(RNB,vectorizer)
    attacker = oa.attackers.TextFoolerAttacker()
    run_test(victim,attacker,y_pred_RNB,test_data["text"],test_labels,"AGNEWS","TextFooler","RNB")
    
    victim = OpenAttackMNB(RNB_50,vectorizer)
    run_test(victim,attacker,y_pred_RNB_50,test_data["text"],test_labels,"AGNEWS","TextFooler","RNB_50")
    
    victim = OpenAttackMNB(RNB_25,vectorizer)
    run_test(victim,attacker,y_pred_RNB_25,test_data["text"],test_labels,"AGNEWS","TextFooler","RNB_25")
    
    victim = OpenAttackMNB(RNB_15,vectorizer)
    run_test(victim,attacker,y_pred_RNB_15,test_data["text"],test_labels,"AGNEWS","TextFooler","RNB_15")
    
    victim = OpenAttackMNB(RNB_5,vectorizer)
    run_test(victim,attacker,y_pred_RNB_5,test_data["text"],test_labels,"AGNEWS","TextFooler","RNB_5")
    victim = OpenAttackMNB(MNB,vectorizer)
    run_test(victim,attacker,y_pred_MNB,test_data["text"],test_labels,"AGNEWS","TextFooler","MNB")
    
    victim = OpenAttackMNB(LR,vectorizer)
    run_test(victim,attacker,y_pred_LR,test_data["text"],test_labels,"AGNEWS","TextFooler","LR")

    
    victim = OpenAttackMNB(RNB,vectorizer)
    attacker = oa.attackers.DeepWordBugAttacker()
    run_test_deepwordbug(victim,attacker,y_pred_RNB,test_data["text"],test_labels,"AGNEWS","DeepWordBug","RNB")
    
    victim = OpenAttackMNB(RNB_50,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_RNB_50,test_data["text"],test_labels,"AGNEWS","DeepWordBug","RNB_50")
    
    victim = OpenAttackMNB(RNB_25,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_RNB_25,test_data["text"],test_labels,"AGNEWS","DeepWordBug","RNB_25")
    
    victim = OpenAttackMNB(RNB_15,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_RNB_15,test_data["text"],test_labels,"AGNEWS","DeepWordBug","RNB_15")
    
    victim = OpenAttackMNB(RNB_5,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_RNB_5,test_data["text"],test_labels,"AGNEWS","DeepWordBug","RNB_5")
    victim = OpenAttackMNB(MNB,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_MNB,test_data["text"],test_labels,"AGNEWS","DeepWordBug","MNB")
    
    victim = OpenAttackMNB(LR,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_LR,test_data["text"],test_labels,"AGNEWS","DeepWordBug","LR")
    
    victim = LSTM
    run_test_deepwordbug(victim,attacker,y_pred_LSTM,test_data["text"],test_labels,"AGNEWS","DeepWordBug","LSTM")
    
        
    victim = LSTM
    run_test(victim,attacker,y_pred_LSTM,test_data["text"],test_labels,"AGNEWS","TextFooler","LSTM")
    
    attacker = oa.attackers.TextBuggerAttacker()
    victim = GRU
    run_test(victim,attacker,y_pred_GRU,test_data["text"],test_labels,"AGNEWS","TextBugger","GRU")
    run_test_deepwordbug(victim,"replaceone",y_pred_GRU,test_data["text"],test_labels,"AGNEWS","DeepWordBug","GRU")
    
    attacker = oa.attackers.TextFoolerAttacker()
    run_test(victim,attacker,y_pred_GRU,test_data["text"],test_labels,"AGNEWS","TextFooler","GRU")
    
    attacker = oa.attackers.PWWSAttacker()
    run_test(victim,attacker,y_pred_GRU,test_data["text"],test_labels,"AGNEWS","PWWS","GRU")
    
    attacker = oa.attackers.TextBuggerAttacker()
    victim = OpenAttackMNB(RNB_BERT,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT,test_data["text"],test_labels,"AGNEWS","TextBugger","RNB_BERT")
    
    victim = OpenAttackMNB(RNB_BERT_50,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_50,test_data["text"],test_labels,"AGNEWS","TextBugger","RNB_BERT_50")
    
    victim = OpenAttackMNB(RNB_BERT_25,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_25,test_data["text"],test_labels,"AGNEWS","TextBugger","RNB_BERT_25")
    
    victim = OpenAttackMNB(RNB_BERT_15,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_15,test_data["text"],test_labels,"AGNEWS","TextBugger","RNB_BERT_15")
    
    victim = OpenAttackMNB(RNB_BERT_5,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_5,test_data["text"],test_labels,"AGNEWS","TextBugger","RNB_BERT_5")
    
    victim = OpenAttackMNB(RNB_BERT,bert_vectorizer)
    run_test_deepwordbug(victim,"replaceone",y_pred_RNB_BERT,test_data["text"],test_labels,"AGNEWS","DeepWordBug","RNB_BERT")
    
    victim = OpenAttackMNB(RNB_BERT_50,bert_vectorizer)
    run_test_deepwordbug(victim,"replaceone",y_pred_RNB_BERT_50,test_data["text"],test_labels,"AGNEWS","DeepWordBug","RNB_BERT_50")
    
    victim = OpenAttackMNB(RNB_BERT_25,bert_vectorizer)
    run_test_deepwordbug(victim,"replaceone",y_pred_RNB_BERT_25,test_data["text"],test_labels,"AGNEWS","DeepWordBug","RNB_BERT_25")
    
    victim = OpenAttackMNB(RNB_BERT_15,bert_vectorizer)
    run_test_deepwordbug(victim,"replaceone",y_pred_RNB_BERT_15,test_data["text"],test_labels,"AGNEWS","DeepWordBug","RNB_BERT_15")
    
    victim = OpenAttackMNB(RNB_BERT_5,bert_vectorizer)
    run_test_deepwordbug(victim,"replaceone",y_pred_RNB_BERT_5,test_data["text"],test_labels,"AGNEWS","DeepWordBug","RNB_BERT_5")
    
    attacker = oa.attackers.TextFoolerAttacker()
    victim = OpenAttackMNB(RNB_BERT,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT,test_data["text"],test_labels,"AGNEWS","TextFooler","RNB_BERT")
    
    victim = OpenAttackMNB(RNB_BERT_50,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_50,test_data["text"],test_labels,"AGNEWS","TextFooler","RNB_BERT_50")
    
    victim = OpenAttackMNB(RNB_BERT_25,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_25,test_data["text"],test_labels,"AGNEWS","TextFooler","RNB_BERT_25")
    
    victim = OpenAttackMNB(RNB_BERT_15,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_15,test_data["text"],test_labels,"AGNEWS","TextFooler","RNB_BERT_15")
    
    victim = OpenAttackMNB(RNB_BERT_5,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_5,test_data["text"],test_labels,"AGNEWS","TextFooler","RNB_BERT_5")
    
    attacker = oa.attackers.PWWSAttacker()
    victim = OpenAttackMNB(RNB_BERT,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT,test_data["text"],test_labels,"AGNEWS","PWWS","RNB_BERT")
    
    victim = OpenAttackMNB(RNB_BERT_50,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_50,test_data["text"],test_labels,"AGNEWS","PWWS","RNB_BERT_50")
    
    victim = OpenAttackMNB(RNB_BERT_25,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_25,test_data["text"],test_labels,"AGNEWS","PWWS","RNB_BERT_25")
    
    victim = OpenAttackMNB(RNB_BERT_15,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_15,test_data["text"],test_labels,"AGNEWS","PWWS","RNB_BERT_15")
    
    victim = OpenAttackMNB(RNB_BERT_5,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_5,test_data["text"],test_labels,"AGNEWS","PWWS","RNB_BERT_5")"""
    attacker = oa.attackers.TextBuggerAttacker()
    victim = BERT
    run_test(victim,attacker,y_pred_BERT,test_data["text"],test_labels,"AGNEWS","TextBugger","BERT")
    run_test_deepwordbug(victim,"replaceone",y_pred_BERT,test_data["text"],test_labels,"AGNEWS","DeepWordBug","BERT")
    attacker = oa.attackers.TextFoolerAttacker()
    run_test(victim,attacker,y_pred_BERT,test_data["text"],test_labels,"AGNEWS","TextFooler","BERT")
    attacker = oa.attackers.PWWSAttacker()
    run_test(victim,attacker,y_pred_BERT,test_data["text"],test_labels,"AGNEWS","PWWS","BERT")
