...
def select_correct_samples(x,y_pred,y_true,sample_amount=1000,random_seed:int =0):
    ...
    sample_number = np.random.choice(len(correct_labels), sample_amount)
...
if __name__ == "__main__":
    ...
    GRU = loadGRUModel("/home/ubuntu/Robustness_Gym/model/weights/GRU/SST2_WordTokenizer",map_location=torch.device("cpu"))
    ...
    run_test(victim,attacker,y_pred_RNB,test_data["text"],test_labels,"SST2","TextBugger","RNB")
    
    victim = OpenAttackMNB(MNB,vectorizer)
    run_test(victim,attacker,y_pred_MNB,test_data["text"],test_labels,"SST2","TextBugger","MNB")
    
    victim = OpenAttackMNB(LR,vectorizer)
    run_test(victim,attacker,y_pred_LR,test_data["text"],test_labels,"SST2","TextBugger","LR")
    
    
    victim = OpenAttackMNB(RNB_50,vectorizer)
    run_test(victim,attacker,y_pred_RNB_50,test_data["text"],test_labels,"SST2","TextBugger","RNB_50")
    
    victim = OpenAttackMNB(RNB_25,vectorizer)
    run_test(victim,attacker,y_pred_RNB_25,test_data["text"],test_labels,"SST2","TextBugger","RNB_25")
    
    victim = OpenAttackMNB(RNB_15,vectorizer)
    run_test(victim,attacker,y_pred_RNB_15,test_data["text"],test_labels,"SST2","TextBugger","RNB_15")
    
    victim = OpenAttackMNB(RNB_5,vectorizer)
    run_test(victim,attacker,y_pred_RNB_5,test_data["text"],test_labels,"SST2","TextBugger","RNB_5")
    
    victim = LSTM
    run_test(victim,attacker,y_pred_LSTM,test_data["text"],test_labels,"SST2","TextBugger","LSTM")
    attacker = oa.attackers.PWWSAttacker()
    victim = OpenAttackMNB(RNB,vectorizer)
     
    run_test(victim,attacker,y_pred_RNB,test_data["text"],test_labels,"SST2","PWWS","RNB")
    
    victim = OpenAttackMNB(RNB_50,vectorizer)
    run_test(victim,attacker,y_pred_RNB_50,test_data["text"],test_labels,"SST2","PWWS","RNB_50")
    
    victim = OpenAttackMNB(RNB_25,vectorizer)
    run_test(victim,attacker,y_pred_RNB_25,test_data["text"],test_labels,"SST2","PWWS","RNB_25")
    
    victim = OpenAttackMNB(RNB_15,vectorizer)
    run_test(victim,attacker,y_pred_RNB_15,test_data["text"],test_labels,"SST2","PWWS","RNB_15")
    
    victim = OpenAttackMNB(RNB_5,vectorizer)
    run_test(victim,attacker,y_pred_RNB_5,test_data["text"],test_labels,"SST2","PWWS","RNB_5")
    victim = OpenAttackMNB(MNB,vectorizer)
    run_test(victim,attacker,y_pred_MNB,test_data["text"],test_labels,"SST2","PWWS","MNB")
    
    victim = OpenAttackMNB(LR,vectorizer)
    run_test(victim,attacker,y_pred_LR,test_data["text"],test_labels,"SST2","PWWS","LR")
    
    victim = LSTM
    run_test(victim,attacker,y_pred_LSTM,test_data["text"],test_labels,"SST2","PWWS","LSTM")
    
    attacker = oa.attackers.TextFoolerAttacker()
    
    victim = OpenAttackMNB(RNB,vectorizer)
    run_test(victim,attacker,y_pred_RNB,test_data["text"],test_labels,"SST2","TextFooler","RNB")
    
    victim = OpenAttackMNB(RNB_50,vectorizer)
    run_test(victim,attacker,y_pred_RNB_50,test_data["text"],test_labels,"SST2","TextFooler","RNB_50")
    
    victim = OpenAttackMNB(RNB_25,vectorizer)
    run_test(victim,attacker,y_pred_RNB_25,test_data["text"],test_labels,"SST2","TextFooler","RNB_25")
    
    victim = OpenAttackMNB(RNB_15,vectorizer)
    run_test(victim,attacker,y_pred_RNB_15,test_data["text"],test_labels,"SST2","TextFooler","RNB_15")
    
    victim = OpenAttackMNB(RNB_5,vectorizer)
    run_test(victim,attacker,y_pred_RNB_5,test_data["text"],test_labels,"SST2","TextFooler","RNB_5")
    victim = OpenAttackMNB(MNB,vectorizer)
    run_test(victim,attacker,y_pred_MNB,test_data["text"],test_labels,"SST2","TextFooler","MNB")
    
    victim = OpenAttackMNB(LR,vectorizer)
    run_test(victim,attacker,y_pred_LR,test_data["text"],test_labels,"SST2","TextFooler","LR")
    
    victim = LSTM
    run_test(victim,attacker,y_pred_LSTM,test_data["text"],test_labels,"SST2","TextFooler","LSTM")
    
    victim = OpenAttackMNB(RNB,vectorizer)
    attacker = oa.attackers.DeepWordBugAttacker()
    run_test_deepwordbug(victim,attacker,y_pred_RNB,test_data["text"],test_labels,"SST2","DeepWordBug","RNB")
    
    victim = OpenAttackMNB(RNB_50,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_RNB_50,test_data["text"],test_labels,"SST2","DeepWordBug","RNB_50")
    
    victim = OpenAttackMNB(RNB_25,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_RNB_25,test_data["text"],test_labels,"SST2","DeepWordBug","RNB_25")
    
    victim = OpenAttackMNB(RNB_15,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_RNB_15,test_data["text"],test_labels,"SST2","DeepWordBug","RNB_15")
    
    victim = OpenAttackMNB(RNB_5,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_RNB_5,test_data["text"],test_labels,"SST2","DeepWordBug","RNB_5")
    victim = OpenAttackMNB(MNB,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_MNB,test_data["text"],test_labels,"SST2","DeepWordBug","MNB")
    
    victim = OpenAttackMNB(LR,vectorizer)
    run_test_deepwordbug(victim,attacker,y_pred_LR,test_data["text"],test_labels,"SST2","DeepWordBug","LR")
    
    victim = LSTM
    run_test_deepwordbug(victim,attacker,y_pred_LSTM,test_data["text"],test_labels,"SST2","DeepWordBug","LSTM")
    
    attacker = oa.attackers.TextBuggerAttacker()
    victim = GRU
    run_test(victim,attacker,y_pred_GRU,test_data["text"],test_labels,"SST2","TextBugger","GRU")
    run_test_deepwordbug(victim,"replaceone",y_pred_GRU,test_data["text"],test_labels,"SST2","DeepWordBug","GRU")
    
    attacker = oa.attackers.TextFoolerAttacker()
    run_test(victim,attacker,y_pred_GRU,test_data["text"],test_labels,"SST2","TextFooler","GRU")
    
    attacker = oa.attackers.PWWSAttacker()
    run_test(victim,attacker,y_pred_GRU,test_data["text"],test_labels,"SST2","PWWS","GRU")"""
    
    
    """attacker = oa.attackers.TextBuggerAttacker()
    victim = OpenAttackMNB(RNB_BERT,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT,test_data["text"],test_labels,"SST2","TextBugger","RNB_BERT")
    
    victim = OpenAttackMNB(RNB_BERT_50,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_50,test_data["text"],test_labels,"SST2","TextBugger","RNB_BERT_50")
    
    victim = OpenAttackMNB(RNB_BERT_25,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_25,test_data["text"],test_labels,"SST2","TextBugger","RNB_BERT_25")
    
    victim = OpenAttackMNB(RNB_BERT_15,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_15,test_data["text"],test_labels,"SST2","TextBugger","RNB_BERT_15")
    
    victim = OpenAttackMNB(RNB_BERT_5,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_5,test_data["text"],test_labels,"SST2","TextBugger","RNB_BERT_5")
    
    victim = OpenAttackMNB(RNB_BERT,bert_vectorizer)
    run_test_deepwordbug(victim,"replaceone",y_pred_RNB_BERT,test_data["text"],test_labels,"SST2","DeepWordBug","RNB_BERT")
    
    victim = OpenAttackMNB(RNB_BERT_50,bert_vectorizer)
    run_test_deepwordbug(victim,"replaceone",y_pred_RNB_BERT_50,test_data["text"],test_labels,"SST2","DeepWordBug","RNB_BERT_50")
    
    victim = OpenAttackMNB(RNB_BERT_25,bert_vectorizer)
    run_test_deepwordbug(victim,"replaceone",y_pred_RNB_BERT_25,test_data["text"],test_labels,"SST2","DeepWordBug","RNB_BERT_25")
    
    victim = OpenAttackMNB(RNB_BERT_15,bert_vectorizer)
    run_test_deepwordbug(victim,"replaceone",y_pred_RNB_BERT_15,test_data["text"],test_labels,"SST2","DeepWordBug","RNB_BERT_15")
    
    victim = OpenAttackMNB(RNB_BERT_5,bert_vectorizer)
    run_test_deepwordbug(victim,"replaceone",y_pred_RNB_BERT_5,test_data["text"],test_labels,"SST2","DeepWordBug","RNB_BERT_5")
    
    attacker = oa.attackers.TextFoolerAttacker()
    victim = OpenAttackMNB(RNB_BERT,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT,test_data["text"],test_labels,"SST2","TextFooler","RNB_BERT")
    
    victim = OpenAttackMNB(RNB_BERT_50,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_50,test_data["text"],test_labels,"SST2","TextFooler","RNB_BERT_50")
    
    victim = OpenAttackMNB(RNB_BERT_25,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_25,test_data["text"],test_labels,"SST2","TextFooler","RNB_BERT_25")
    
    victim = OpenAttackMNB(RNB_BERT_15,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_15,test_data["text"],test_labels,"SST2","TextFooler","RNB_BERT_15")
    
    victim = OpenAttackMNB(RNB_BERT_5,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_5,test_data["text"],test_labels,"SST2","TextFooler","RNB_BERT_5")
    
    attacker = oa.attackers.PWWSAttacker()
    victim = OpenAttackMNB(RNB_BERT,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT,test_data["text"],test_labels,"SST2","PWWS","RNB_BERT")
    
    victim = OpenAttackMNB(RNB_BERT_50,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_50,test_data["text"],test_labels,"SST2","PWWS","RNB_BERT_50")
    
    victim = OpenAttackMNB(RNB_BERT_25,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_25,test_data["text"],test_labels,"SST2","PWWS","RNB_BERT_25")
    
    victim = OpenAttackMNB(RNB_BERT_15,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_15,test_data["text"],test_labels,"SST2","PWWS","RNB_BERT_15")
    
    victim = OpenAttackMNB(RNB_BERT_5,bert_vectorizer)
    run_test(victim,attacker,y_pred_RNB_BERT_5,test_data["text"],test_labels,"SST2","PWWS","RNB_BERT_5")"""
    
    attacker = oa.attackers.TextBuggerAttacker()
    victim = BERT
    run_test(victim,attacker,y_pred_BERT,test_data["text"],test_labels,"SST2","TextBugger","BERT")
    run_test_deepwordbug(victim,"replaceone",y_pred_BERT,test_data["text"],test_labels,"SST2","DeepWordBug","BERT")
    attacker = oa.attackers.TextFoolerAttacker()
    run_test(victim,attacker,y_pred_BERT,test_data["text"],test_labels,"SST2","TextFooler","BERT")
    attacker = oa.attackers.PWWSAttacker()
    run_test(victim,attacker,y_pred_BERT,test_data["text"],test_labels,"SST2","PWWS","BERT")
